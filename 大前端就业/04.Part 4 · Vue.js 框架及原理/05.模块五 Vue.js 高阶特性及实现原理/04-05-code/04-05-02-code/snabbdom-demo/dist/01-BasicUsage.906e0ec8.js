...
// 1 通过 h 函数创建 VNode
var vNode = (0, _h.h)('div#box.container', '新内容'); // 获取挂载元素

var dom = document.querySelector('#app'); // 2 通过 init 函数得到 patch 函数

var patch = (0, _init.init)([]); // 3 通过 patch，将 vNode 渲染到 DOM

var oldVNode = patch(dom, vNode); // 4 创建新的 VNode，更新给 oldVNode

vNode = (0, _h.h)('p#text.abc', '这是p标签的内容');
...
//# sourceMappingURL=/01-BasicUsage.906e0ec8.js.map